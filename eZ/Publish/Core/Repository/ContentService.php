...
class ContentService implements ContentServiceInterface
{
    ...
    public function loadContentByRemoteId( $remoteId, array $languages = null, $versionNo = null )
    {
        ...
        if (
            ...
            throw new UnauthorizedException( 'content', 'versionread', array( 'remoteId' => $remoteId ) );
    ...
    public function deleteVersion( APIVersionInfo $versionInfo )
    {
        ...
        if ( !$this->repository->canUser( 'content', 'versionremove', $versionInfo ) )
            throw new UnauthorizedException( 'content', 'versionremove', array( 'contentId' => $versionInfo->contentInfo->id ) );
